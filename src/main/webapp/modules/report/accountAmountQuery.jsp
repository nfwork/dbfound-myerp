	...
	<body>
		...
		<d:form id="queryForm" title="查询条件" labelWidth="90">
			<d:line columnWidth="0.33">
				<d:field name="period_code_from" editable="false" value="${periods[0].period}" required="true" anchor="85%" options="periodStore" valueField ="period_code" displayField="period_name" editor="combo" prompt="本期期间从" >
					<d:event name="select" handle="query"/>
				</d:field>
				<d:field name="period_code_to" editable="false" value="${periods[0].period}" required="true" anchor="85%" options="periodStore" valueField ="period_code" displayField="period_name" editor="combo" prompt="本期期间到" >
					<d:event name="select" handle="query"/>
				</d:field>

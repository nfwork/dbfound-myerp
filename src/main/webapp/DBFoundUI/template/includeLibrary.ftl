...
<script type='text/javascript' src='${basePath}DBFoundUI/dbfound-base.js?v1' charset='utf-8'></script>
<script type="text/javascript" src="${basePath}DBFoundUI/dbfound-grid.js?v1" charset='utf-8'></script>

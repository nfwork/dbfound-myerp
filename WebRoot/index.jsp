...
<html>
	...
	<body style="overflow: hidden">
		...
		<script type="text/javascript">
			var menuTab = new Ext.TabPanel( {
				...
				items : [ {
					...
					html : "<div style='height:100%;overflow:hidden'><iframe id='TAB8YM10_iframe' src='modules/report/welcome.jsp' frameBorder=0 width='100%' height='100%'></iframe></div>"
				} ]
			});
		</script>
		...
		<script type="text/javascript">
			var vp=new Ext.Viewport({
				...
				items:[
					...
					{region: 'south',border: false,height: 25,html:'<div style="text-align:center;height:30px;background-color:#dfe8f6;padding:3px;">NFWork版权所有 2014-2015。MyERP更好用的ERP</div>'}, 
					menuTree,
					menuTab
				]
			});
	    ...
	    <div style="background-color:#306091;position:absolute;top:0;left:0;z-index:1;width:100%;">
	        <font style="float:left;margin-left:5px;margin-top:5px;width:200px;height:28px;" color="#ffffff" size="5"><b>MyERP财务系统</b></font>
